...
export class Game {
    constructor(gameDuration, carrotCount, bugCount){
        ...
        this.carrotCounter = document.querySelector('.game__score');
    ...
    updateScoreBoard(){
        this.carrotCounter.innerText = this.carrotCount - this.score;
    };
    ...
    showTimerAndScore() {
        ...
        this.carrotCounter.style.visiblity = 'visible';
    };
